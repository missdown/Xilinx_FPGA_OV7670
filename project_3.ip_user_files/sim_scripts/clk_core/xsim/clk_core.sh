...
#
# Generated by Vivado on Fri Dec 29 22:26:26 +0800 2017
...
# Script info
echo -e "clk_core.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_core xil_defaultlib.clk_core xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_core -key {Behavioral:sim_1:Functional:clk_core} -tclbatch cmd.tcl -log simulate.log
}
