...
#
# Generated by Vivado on Fri Dec 29 22:45:52 +0800 2017
...
# Script info
echo -e "char_fifo.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot char_fifo xil_defaultlib.char_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim char_fifo -key {Behavioral:sim_1:Functional:char_fifo} -tclbatch cmd.tcl -log simulate.log
}
